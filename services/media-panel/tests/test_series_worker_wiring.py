...
def test_series_worker_uses_only_the_approved_mounts_and_paths() -> None:
    ...
    assert mounts == {
        "- ${ARR_DATA_ROOT}/downloads/torrents/complete/taller:/data/downloads/torrents/complete/taller",
        "- ${ARR_DATA_ROOT}/media/tv:/data/media/tv",
        "- ${ARR_DATA_ROOT}/media/repetidas_vs_error_series:/data/media/repetidas_vs_error_series",
    ...
    for expected in (
        ...
        'SERIES_WORKER_REVIEW_ROOT: "/data/media/repetidas_vs_error_series"',
